...
<head>
    ...
    <title>BOS | Livros Gratuitos</title>
...
<body>
    <div class="section-hero  uk-background-top-center uk-background-cover uk-section-large1 cta" style="background-image: url(assets/img/books.png)" >
        <nav class="uk-navbar-container uk-margin uk-navbar-transparent uk-light">
            <div class="uk-container">
                <div uk-navbar>
                    <div class="uk-navbar-left">
                        <a class="uk-navbar-item uk-logo uk-text-uppercase" href="/"><span class="uk-margin-small-right" uk-icon="icon: lifesaver"></span> BOS | Livros Gratuitos </a>
                    </div>
                    <div class="uk-navbar-right">
                        <ul class="uk-navbar-nav uk-text-uppercase uk-visible@m uk-margin-medium-left">
                            
                            <li>
                                <a href="/modules">Categorias</a>
            ...
            <div class="uk-container hero">
                <h1 class="uk-heading-primary uk-text-center uk-margin-large-top uk-light">Boooks Open Source</h1>
                <p class="uk-text-lead uk-text-center uk-light"><b>BOS, Levando a <strong> Educação</strong> para onde mais precisa! </b></p>
